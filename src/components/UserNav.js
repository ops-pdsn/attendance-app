...
export default function UserNav() {
  ...
  const DropdownMenu = () => (
    <div
      ref={dropdownRef}
      className="fixed w-72 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden overflow-y-auto"
      style={{
...
>
  ...
  return (
    <>
      ...
      >
        {/* Avatar */}
        <div className={`w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br ${getAvatarGradient()} rounded-xl flex items-center justify-center text-white font-semibold text-sm shadow-lg`}>
          {initials}
        </div>
